...
image:./images/Transit-App-2.jpg[Launch,scaledheight=30%]
...
image:./images/Transit-App-3.jpg[Use Google Authentication to authenticate,scaledheight=20%]
...
The Application home page shows the list of Routes you are interested in getting notified on. 

image:./images/Transit-App-4.jpg[Fetch Routes,scaledheight=20%]
...
image:./images/Transit-App-6.jpg[Notify,scaledheight=20%] image:./images/Transit-App-7.jpg[Notify,scaledheight=20%] image:./images/Transit-App-8.jpg[Notify,scaledheight=20%]


.Delete or Unsubscribe Notification 
