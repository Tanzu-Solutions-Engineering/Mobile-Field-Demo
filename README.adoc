...
The microservice architecture can introduce operational complexity, careful coordination between the various development teams, 
...
link:http://www.infoq.com/articles/microservices-intro[Introduction to Microservices]
