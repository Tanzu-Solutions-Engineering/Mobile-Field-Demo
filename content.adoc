...
=== 1. Agile Mobile Application Delivery requires Microservices based architecture on a Platform
...
=== 2. Trend from existing mBaas Solutions to a Enterprise PAAS Platform for Mobility
...
=== 3. Continous Delivery and Innovation best practices on Platform for Mobility
